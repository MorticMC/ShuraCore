...
public class ItemBuilder {
    ...
    public ItemBuilder name(String name) {
        meta.displayName(ColorUtil.color(name).decoration(net.kyori.adventure.text.format.TextDecoration.ITALIC, false));
        return this;
    }
    ...
    public ItemBuilder lore(String... lines) {
        meta.lore(Arrays.stream(lines).map(line -> ColorUtil.color(line).decoration(net.kyori.adventure.text.format.TextDecoration.ITALIC, false)).toList());
        return this;
    }

    public ItemBuilder lore(List<Component> lore) {
        meta.lore(lore.stream().map(line -> line.decoration(net.kyori.adventure.text.format.TextDecoration.ITALIC, false)).toList());
        return this;
    }
