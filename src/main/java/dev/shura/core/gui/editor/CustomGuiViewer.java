...
public class CustomGuiViewer {
    ...
    private void handleClick(Player player, int slot) {
        // Click handling for chest-type GUIs is done here
        // Non-chest types are handled in CustomGuiListener
