...
public class Profile {
    ...
    // Per-tierlist ELO — key: tierlist ID, value: ELO
    private final Map<String, Integer> tierlistElo = new HashMap<>();
    ...
    // ELO helpers
    public int getElo(String tierlistId) {
        return tierlistElo.getOrDefault(tierlistId, 1000);
    }

    public void setElo(String tierlistId, int elo) {
        tierlistElo.put(tierlistId, Math.max(100, elo));
    }

    public void addElo(String tierlistId, int amount) {
        setElo(tierlistId, getElo(tierlistId) + amount);
    }
    ...
    public boolean isInPlacement(String tierlistId) {
        return getMatches(tierlistId) < 30;
    }
    ...
    public Map<String, Integer> getTierlistElo() { return tierlistElo; }
